		...
		exportSubCat: {label:"Export", expanded:true, 
			items: {
				...
				ProjectName:             { label:"Project Name", type:"string", popupText: "Project Name is used as the default file names for zip-file export and JSON-save to file.<br>"+
																						"It's also used at the default savename for the autosave function, when replacing the whole design with a template design."+
																						"When naming a tab with  [ProjectName].ino (not including the []), that defines it's the main ino-file if the export is exported to Arduino IDE."},
