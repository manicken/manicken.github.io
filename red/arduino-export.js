    ...
    base()
    {
        if (this.staticType==true) return RED.arduino.export.getAudioConnectionTypeName() + "        patchCord"+this.count + "(";
            ...
            if (this.dstRootIsArray || this.srcRootIsArray)
                return RED.arduino.export.getNrOfSpaces(this.majorIncrement+this.minorIncrement) + "patchCord[pci++] = new "+RED.arduino.export.getAudioConnectionTypeName()+"(";
            else
                return RED.arduino.export.getNrOfSpaces(this.majorIncrement) + "patchCord[pci++] = new "+RED.arduino.export.getAudioConnectionTypeName()+"(";
        }
    }
    ifAnyIsArray()
    {
