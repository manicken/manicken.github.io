...
<li class="dropdown-submenu pull-left"><a tabindex="-1" href="#"><i class="icon-th-large"></i> Workspaces</a>
			...
			<div class="btn-group pull-left">
				...
				<a id="btn-deploy2" class="btn action-deploy " href="#"><i id="btn-icn-deploy" class="icon-upload"></i>ExportAsClass</a>
...
<script type="text/x-red" data-template-name="export-clipboard-dialog">
	...
	<div class="form-row">
		<label for="node-input-export2" style="display: block; width:100%;"><i class="icon-share"></i> Source Code:</label>
		<textarea readonly style="font-family: monospace; font-size: 12px; background:rgb(226, 229, 255); padding-left: 0.5em;" class="input-block-level" id="node-input-export2" rows="12"></textarea>
	</div>
</script>
...
<script  type="text/x-red" data-container-name="NodeDefinitions">
	{"nodes":[
		{"type":"TabOutput","data":{"defaults":{"name":{"value":"new"}},"shortName":"TabOutput","inputs":1,"outputs":0,"category":"output-function","color":"#E6E0F8","icon":"arrow-in.png"}},
		{"type":"TabInput","data":{"defaults":{"name":{"value":"new"}},"shortName":"TabInput","inputs":0,"outputs":1,"category":"input-function","color":"#E6E0F8","icon":"arrow-in.png"}},
		{"type":"AudioMixerX","data":{"defaults":{"name":{"value":"new"}},"shortName":"MixerX","inputs":1,"outputs":1,"category":"mixer-function","color":"#E6E0F8","icon":"arrow-in.png"}},
		...
		{"type":"AudioMixer2","data":{"defaults":{"name":{"value":"new"}},"shortName":"mixer2","inputs":2,"outputs":1,"category":"mixer-function","color":"#E6E0F8","icon":"arrow-in.png"}},
		...
		{"type":"AudioMixer32","data":{"defaults":{"name":{"value":"new"}},"shortName":"mixer32","inputs":32,"outputs":1,"category":"mixer-function","color":"#E6E0F8","icon":"arrow-in.png"}},
...
<script type="text/x-red" data-help-name="TabInput">
	<h3>Summary</h3>
...
<script type="text/x-red" data-template-name="TabInput">
	<div class="form-row">
...
<script type="text/x-red" data-help-name="TabOutput">
	<h3>Summary</h3>
	<div class=tooltipinfo>
	<p></p>
...
<script type="text/x-red" data-template-name="TabOutput">
	<div class="form-row">
		<label for="node-input-name"><i class="fa fa-tag"></i> Name</label>
		<input type="text" id="node-input-name" placeholder="Name">
	</div>
...
<script type="text/x-red" data-help-name="AudioMixerX">
	<h3>Summary</h3>
	<div class=tooltipinfo>
	<p>Combine up to n audio signals together, each with adjustable gain.
		All channels support signal attenuation or amplification.</p>
	</div>
	<h3>Audio Connections</h3>
	<table class=doc align=center cellpadding=3>
		<tr class=top><th>Port</th><th>Purpose</th></tr>
		<tr class=odd><td align=center>In 0</td><td>Input signals from array typed Object #1</td></tr>
	...
	<p class=desc>Adjust the amplification or attenuation.  "channel" must
		be 0 to n.  "level" may be any floating point number from 0 to 32767.0.
		...
		signal.  All 2 channels have separate gain settings.
	</p>
	<h3>Examples</h3>
	...
	<p>if you need more inputs you can create own special mixer with any number of inputs
	</p>
</script>
<script type="text/x-red" data-template-name="AudioMixerX">
	<div class="form-row">
		<label for="node-input-name"><i class="fa fa-tag"></i> Name</label>
		<input type="text" id="node-input-name" placeholder="Name">
	</div>
...
<script type="text/x-red" data-help-name="AudioMixer2">
	<h3>Summary</h3>
	<div class=tooltipinfo>
	<p>Combine up to 2 audio signals together, each with adjustable gain.
		All channels support signal attenuation or amplification.</p>
	</div>
	<h3>Audio Connections</h3>
	<table class=doc align=center cellpadding=3>
	...
	<p class=func><span class=keyword>gain</span>(channel, level);</p>
	<p class=desc>Adjust the amplification or attenuation.  "channel" must
		be 0 to 1.  "level" may be any floating point number from 0 to 32767.0.
		1.0 passes the signal through directly.  Level of 0 shuts the channel
		off completely.  Between 0 to 1.0 attenuates the signal, and above
		1.0 amplifies it.  Negative numbers may also be used, to invert the
		signal.  All 2 channels have separate gain settings.
...
<script type="text/x-red" data-template-name="AudioMixer2">
	<div class="form-row">
		<label for="node-input-name"><i class="fa fa-tag"></i> Name</label>
		<input type="text" id="node-input-name" placeholder="Name">
	</div>
...
<script type="text/x-red" data-help-name="AudioMixer32">
	<h3>Summary</h3>
	<div class=tooltipinfo>
	<p>Combine up to 32 audio signals together, each with adjustable gain.
		All channels support signal attenuation or amplification.</p>
	</div>
	<h3>Audio Connections</h3>
	<table class=doc align=center cellpadding=3>
		...
		<tr class=odd><td align=center>In 8</td><td>Input signal #9</td></tr>
		<tr class=odd><td align=center>In 9</td><td>Input signal #10</td></tr>
		<tr class=odd><td align=center>In 10</td><td>Input signal #11</td></tr>
		<tr class=odd><td align=center>In 11</td><td>Input signal #12</td></tr>
		<tr class=odd><td align=center>In 12</td><td>Input signal #13</td></tr>
		<tr class=odd><td align=center>In 13</td><td>Input signal #14</td></tr>
		<tr class=odd><td align=center>In 14</td><td>Input signal #15</td></tr>
		<tr class=odd><td align=center>In 15</td><td>Input signal #16</td></tr>
		<tr class=odd><td align=center>In 16</td><td>Input signal #17</td></tr>
		<tr class=odd><td align=center>In 17</td><td>Input signal #18</td></tr>
		<tr class=odd><td align=center>In 18</td><td>Input signal #19</td></tr>
		<tr class=odd><td align=center>In 19</td><td>Input signal #20</td></tr>
		<tr class=odd><td align=center>In 20</td><td>Input signal #21</td></tr>
		<tr class=odd><td align=center>In 21</td><td>Input signal #22</td></tr>
		<tr class=odd><td align=center>In 22</td><td>Input signal #23</td></tr>
		<tr class=odd><td align=center>In 23</td><td>Input signal #24</td></tr>
		<tr class=odd><td align=center>In 24</td><td>Input signal #25</td></tr>
		<tr class=odd><td align=center>In 25</td><td>Input signal #26</td></tr>
		<tr class=odd><td align=center>In 26</td><td>Input signal #27</td></tr>
		<tr class=odd><td align=center>In 27</td><td>Input signal #28</td></tr>
		<tr class=odd><td align=center>In 28</td><td>Input signal #29</td></tr>
		<tr class=odd><td align=center>In 29</td><td>Input signal #30</td></tr>
		<tr class=odd><td align=center>In 30</td><td>Input signal #31</td></tr>
		<tr class=odd><td align=center>In 31</td><td>Input signal #32</td></tr>
		<tr class=odd><td align=center>Out 0</td><td>Sum of all inputs</td></tr>
	</table>
	<h3>Functions</h3>
	<p class=func><span class=keyword>gain</span>(channel, level);</p>
	<p class=desc>Adjust the amplification or attenuation.  "channel" must
		be 0 to 31.  "level" may be any floating point number from 0 to 32767.0.
		1.0 passes the signal through directly.  Level of 0 shuts the channel
		off completely.  Between 0 to 1.0 attenuates the signal, and above
		1.0 amplifies it.  Negative numbers may also be used, to invert the
		signal.  All 32 channels have separate gain settings.
	</p>
	<h3>Examples</h3>
	<p class=exam>File &gt; Examples &gt; Audio &gt; SamplePlayer
	</p>
...
<script type="text/x-red" data-template-name="AudioMixer32">
	<div class="form-row">
		<label for="node-input-name"><i class="fa fa-tag"></i> Name</label>
		<input type="text" id="node-input-name" placeholder="Name">
	</div>
